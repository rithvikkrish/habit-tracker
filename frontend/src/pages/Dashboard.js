  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0d1117', fontFamily:FONT, color:'#fff', position:'relative', overflowX:'hidden' }}>
      ...
      <nav style={{ position:'relative', zIndex:10, background:'#0d1117', borderBottom:`1px solid rgba(0,229,255,0.1)`, padding:'0 36px', display:'flex', alignItems:'center', justifyContent:'space-between', height:66, boxShadow:'0 2px 24px rgba(0,0,0,0.5)' }}>
        <span style={{ fontWeight:800, fontSize:'1.45rem', background:GRAD, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent', letterSpacing:0.5 }}>⚡ TaskMaster</span>
      ...
      <div style={{ position:'relative', zIndex:5, maxWidth:1200, margin:'0 auto', padding:'32px 28px' }}>
          ...
          <div style={{ animation:'fadeUp 0.3s ease' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
              ...
              {habits.map(habit => {
                ...
                return (
                  <div key={habit.id} style={{ ...card, border:`1px solid rgba(255,255,255,0.07)` }}>
        ...
        {activeTab === 'analytics' && (
          <div style={{ animation:'fadeUp 0.3s ease' }}>
            <h2 style={{ marginBottom:18, fontSize:'1.25rem', fontWeight:700 }}><span style={{fontFamily:EMOJI}}>📊</span> Analytics</h2>
            <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(260px,1fr))', gap:16 }}>

              <div style={card}>
                <h3 style={{ margin:'0 0 18px', fontSize:'0.95rem', color:CYAN, fontFamily:EMOJI }}>✅ Task Completion</h3>
                <div style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:14 }}>
                  <div style={{ position:'relative', width:130, height:130 }}>
                    ...
                    <div style={{ position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', fontSize:'1.4rem', fontWeight:800, background:GRAD, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent' }}>
              ...
              <div style={card}>
                <h3 style={{ margin:'0 0 18px', fontSize:'0.95rem', color:CYAN, fontFamily:EMOJI }}>🔥 Habit Streaks</h3>
              ...
              <div style={card}>
                <h3 style={{ margin:'0 0 18px', fontSize:'0.95rem', color:CYAN, fontFamily:EMOJI }}>📌 Tasks by Priority</h3>
                  ...
                  return (
                    <div key={p} style={{ marginBottom:14 }}>
                      ...
                      <div style={{ height:6, background:'rgba(255,255,255,0.05)', borderRadius:3 }}>
                        <div style={{ height:'100%', width:`${total>0?(count/total)*100:0}%`, background:`linear-gradient(90deg,${pColor[p]},${CYAN})`, borderRadius:3, transition:'width 0.6s', boxShadow:`0 0 8px ${pColor[p]}55` }} />
                      </div>
                    </div>
                  );
                })}
